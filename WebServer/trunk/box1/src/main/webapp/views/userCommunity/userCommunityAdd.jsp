...
<script type="text/javascript">
	    ...
	    if(data.listInfo!=null && data.listInfo.length>0){
		    for(var i=0;i<data.listInfo.length;i++){
		        tempHtml +=
		            ...
		            "<td>"+data.listInfo[i].communityName+"</td>"+
		            "<td>"+data.listInfo[i].communityCode+"</td>"+
		            "<td>"+data.listInfo[i].communityUser+"</td>"+
		            "<td>"+data.listInfo[i].communityContact+"</td>"+
		            "<td>"+data.listInfo[i].communityPropertyCompany+"</td>"+
		            "<td>"+data.listInfo[i].communityPropertyStaff+"</td>"+
		            "</tr>";
		    }
	    }
	...
	function saveCommunity(userId){
		...
		if(ids.length>0){
			...
			$.ajax({
				url:"userCommunity/userCommunitySave.shtml",
	           	data:{
...
<body style="background:#FFF">
	<div class="navi_area">
	    <span>
			&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)">当前位置</a>：&nbsp;<a href="javascript:void(0)">管理员管理</a>&nbsp; >> &nbsp;<a href="javascript:void(0)">社区添加</a>
		</span>
	</div>
	<div class="oper_area">
	    <table>
	    	<tr>
		        <td width="500px" align="left">
		        	<input type="button" value="添加" class="CBtext" onclick="saveCommunity(${userId })" />
	        	</td>
	        	<td>&nbsp;</td>
	      	</tr>
	    </table>
	...
	<div class="list_area">
 	...
 	<form action="<%=basePath%>userCommunity/userCommunityAddList.shtml" method="post" id="queryForm">
