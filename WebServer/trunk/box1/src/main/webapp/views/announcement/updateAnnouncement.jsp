...
<html>
    ...
    <body style="background:#FFF">
        <div class="navi_area">
        	<span>
            	&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)">当前位置</a>：&nbsp;<a href="javascript:void(0)">公告管理</a>&nbsp; >> &nbsp;<a href="javascript:void(0)">修改</a>
            </span>
        </div>
        <div class="clear"></div>
		...
		<form action="announcement/updateAnnouncement.shtml" method="post" id="updateAnnouncementForm" >
               <table id="queryTable" width="100%" border="0" cellspacing="1" cellpadding="6" align="left" bgcolor="#DDDDDD" style="font-size: 12px;">
                        <tr>
                            ...
                            <td bgcolor="#FFFFFF">
                                <label>
                                    <input name="announcementTitle" id="announcementTitle" value="<%=Announcement.getAnnouncementTitle() %>" type="text" size="30" maxlength="30" class="b12" style="border:#999999 1px solid; height:21px; padding-top:3px"><em></em>
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td bgcolor="#FFFFFF">
                                <label>
                                    <textarea id="announcementContent" name="announcementContent"><%=Announcement.getAnnouncementContent()%></textarea><em></em>
                                </label>
                            </td>
                        </tr>
                         <tr>
                            ...
                            <td bgcolor="#FFFFFF">
                                <label>
                                    <textarea id="remarks" name="remarks" cols="60" rows="5"><%=Announcement.getRemarks()%></textarea><em></em>
                                </label>
                            </td>
                        </tr>
                        <tr align="center">
