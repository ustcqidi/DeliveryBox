...
public class DeliveryService {
	...
	public void saveOrUpdate(AppUser appUser){
		if(appUser.getId() == null){
			...
			AppUser app = findUserByTel(appUser.getTel());
			app.setCompany(appUser.getCompany());
			app.setUser_desc(appUser.getUser_desc());
			app.setTel(appUser.getTel());
			app.setDelivery_price_desc(appUser.getDelivery_price_desc());
