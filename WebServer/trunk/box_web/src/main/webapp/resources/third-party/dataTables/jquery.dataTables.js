...
(function($, window, document) {
	...
	_oExt.oPagination = {
	     ...
	     *           node:nPaging - the DIV which contains this pagination control
			...
			"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
			{
				...
				var nInputObj = $(nInput);
				var nButtonObj = $(nButton);
				nInputObj.addClass("jumpinput");
				nInputObj.attr("type","text");
				nInputObj.attr("placeholder","输入跳转页");
				nInputObj.attr("maxLength","6");
				nInputObj.attr("size","6");
				nButtonObj.addClass("jumpbutton");
				nButtonObj.addClass("paginate_button");
				
				nFirst.innerHTML = oSettings.oLanguage.oPaginate.sFirst;
				nPrevious.innerHTML = oSettings.oLanguage.oPaginate.sPrevious;
				nNext.innerHTML = oSettings.oLanguage.oPaginate.sNext;
				nLast.innerHTML = oSettings.oLanguage.oPaginate.sLast;
				nButton.innerHTML = "跳转";
				...
				nButtonObj.bind( 'click.DT',function(){
					var $jumpSpan = $(this).parent().find("span.jumpnum");
					$jumpSpan[0].innerHTML = nInput.value;
					$jumpSpan.click();
				} );
			...
			"fnUpdate": function ( oSettings, fnCallbackDraw )
			{
				...
				sList += '<span class="'+oClasses.sPageButton+', jumpnum" style="display:none">' + iCurrentPage + '</span>';
				/* Loop over each instance of the pager */
				var an = oSettings.aanFeatures.p;
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnAddOptionsHtml ( oSettings )
		{
			...
			var nTmp = null, iPushFeature, cOption, nNewNode, cNext, sAttr, j;
		...
		function _fnScrollDraw ( o )
		{
			var
				...
				i, iLen, anHeadToSize, anHeadSizers, anFootSizers = null, anFootToSize, oStyle, iVis,
		...
		function _fnUpdateInfo ( oSettings )
		{
			...
			else if ( oSettings.fnRecordsDisplay() == oSettings.fnRecordsTotal() )
			{
				...
				sOut = oSettings.oLanguage.sInfo.
						...
						replace('_PAGENUM_',oSettings.fnFormatNumber(Math.ceil(iTotal/oSettings._iDisplayLength)))+ 
					oSettings.oLanguage.sInfoPostFix;
			}
			else
			{
				/* Record set after filtering (sEnd-sStart+1)*/
				sOut = oSettings.oLanguage.sInfo.
						replace('_START_', sStart).
						replace('_END_',   sEnd).
						replace('_TOTAL_', sTotal).
