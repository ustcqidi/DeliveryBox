package com.ustc.deliverybox.engineio.client.transports;


import com.ustc.deliverybox.engineio.client.Transport;
...
public class WebSocket extends Transport {
    ...
    protected void doOpen() {
        ...
        try {
            this.ws = new WebSocketClient(new URI(this.uri()), new Draft_17(), headers) {
                @Override
