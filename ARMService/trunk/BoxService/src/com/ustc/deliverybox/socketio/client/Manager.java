...
import com.ustc.deliverybox.socketio.parser.Packet;
import com.ustc.deliverybox.socketio.parser.Parser;
import com.ustc.deliverybox.thread.EventThread;
...
public class Manager extends Emitter {
    ...
    /*package*/ com.ustc.deliverybox.engineio.client.Socket engine;
    ...
    public Manager open(final OpenCallback fn) {
        EventThread.exec(new Runnable() {
            ...
            public void run() {
                ...
                final com.ustc.deliverybox.engineio.client.Socket socket = Manager.this.engine;
    ...
    private void onopen() {
        ...
        final com.ustc.deliverybox.engineio.client.Socket socket = this.engine;
    ...
    private static class Engine extends com.ustc.deliverybox.engineio.client.Socket {
    ...
    public static class Options extends com.ustc.deliverybox.engineio.client.Socket.Options {
